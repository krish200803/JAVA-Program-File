...
//		System.out.println(Arrays.toString(frequencyOfEle(a)));
		...
		System.out.println("freq[] : "+Arrays.toString(Frequency_Of_Each_in_Array.frequencyOfEle(a)));  
		// call frequencyOfEle() method using class name.
		
		System.out.println("ans[] : "+Arrays.toString(removeDuplicates(a)));
	...
	public static int[] removeDuplicates(int[] a)
	{
		...
		{
			if(freq[i] != -1)                          // a[] :    [10, 20, 30, 2, 40, 6, 2, 10, 30]
			{                                          // freq[] : [1, 0, 1, 1, 0, 0, -1, -1, -1]
				ans[j] = a[i];                         // ans[] :  [10, 20, 30, 2, 40, 6]
				j++;
			}
		}
		return ans;
